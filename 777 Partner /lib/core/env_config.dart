class EnvConfig {
  ...
  static String get apiBaseUrl => "http://127.0.0.1:5001/api";
  static String get fallbackBaseUrl => "http://10.116.176.136:5001/api";
  static String get lanBaseUrl => "http://10.116.176.136:5001/api";
